...
After pushing to `main`, the workflow will run and deploy according to the configured provider. For Render, prefer connecting the repository directly in the provider UI and set environment variables there.
